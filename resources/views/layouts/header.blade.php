<header>
    <section class="overflow-hidden">
        <div>
                ...
                <div class="flex items-center justify-between -m-2 ">
                    <div class="flex flex-wrap items-center w-auto p-2">
                        <a class="block max-w-max 2xl:mr-2" href="/">
                            <img src="/img/examprince_dark_svg.svg" alt="" class="h-5" />
                        </a>
                        <ul class="hidden 2xl:flex flex-nowrap">
                            <li class="mr-3">
                                <a href="/exam-providers">
                                    <a class="flex flex-wrap items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500"
                                        ...
                                        <p class="text-gray-600 font-bold">Vendors &amp; Certifications</p>
                                    </a>
                                </a>
                            </li>
                            <li class="relative group mr-3">
                                <a href="/video-courses">
                                    <span
                                    ...
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                            ...
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                ...
                                                d="m24 18.011l7.041 7.04L24 32.092l-7.041-7.041z"></path>
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round"
                                            ...
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                d="m21.898 3l22.051 22.051L24 45L4.051 25.051l7.034-7.033"></path>
                                        </svg>
                                        <p class="text-gray-600 font-bold">Unlimited Access</p>
                                    </span>
                                </a>
                            </li>
                            <li class="relative group mr-3">
                                <a href="/test-engine-simulator">
                                    <span
                                        class="flex items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500 cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                    ...
                    <div class="w-auto p-2">
                        <div class="hidden 2xl:flex flex-wrap items-center -m-3">
                            <div class="w-auto p-2 flex"></div>
                            <style data-emotion="css 1wf493t">
                                .css-1wf493t {
                                    text-align: center;
                            ...
                            <style data-emotion="css 1yxmbwk">
                                .css-1yxmbwk {
                            ...
                            <button
                                class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium px-2 ml-2 css-1yxmbwk"
                                ...
                                <a class="flex items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500 cursor-pointer"
                                    ...
                                    <div class="text-base  ">
                                        <span style="padding-left:8px;padding-right:8px;padding-bottom:2px"
                                            class="rounded-full bg-green-500 text-white">0</span>
                                    </div>
                                    <p class="text-lg ml-1 text-gray-600 font-medium">Cart</p>
                                </a>
                            </div>
                            <div class="w-auto p-3">
                                <a href="/login">
                                    <b style="padding:10px"
                                        class="hover:text-white  hover:border-gray-700 border-gray-700 border-2 text-gray-700 hover:bg-gray-700">Log
                                        In</b>
                                </a>
                                <a style="padding:10px;margin-left:4px"
                        ...
                        <div class="flex">
                            <span class="2xl:hidden">
                                ...
                                <button
                                    class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium px-2 ml-2 2xl:hidden css-1yxmbwk"
                                    tabindex="0" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
                            ...
                            <button class="navbar-burger self-center ml-auto block 2xl:hidden">
            ...
            <div
                class="navbar-menu z-50 fixed top-0 hidden 2xl:hidden flex-col justify-between bg-white max-w-xs w-9/12 h-full overflow-y-auto custom-scrollbar">
                ...
                <div class="relative bg-white flex-1 boLink-gray-700 border-b">
                    <div
                        class="fixed flex justify-between -left-1 p-4 pl-6 -my-4  max-w-xs w-11/12 z-50 bg-gray-50">
                        <span class="block mt-5  max-w-max" href="#">
                            <img src="/img/examprince_dark_svg.svg" alt="" height="170px"
                                width="170px" />
                        </span>
                        <div class="w-auto pr-3 pt-1 -mb-2">
                            <button class="text-gray-500 hover:text-gray-600 -mr-4 mt-3" href="#">
                    ...
                    <div class="mt-20 custom-scrollbar">
                        <p class="px-8 mb-2 text-xs font-medium text-gray-500 uppercase">Main menu</p>
                        <ul class="px-4 mb-8">
                            <li>
                                <span
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Vendors / Certifications</p>
                                    </div>
                            ...
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Video Courses</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Unlimited Access</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Cart</p>
                                    </div>
                                </a>
                            </li>
                        </ul>
                        <p class="px-8 mb-2 text-xs font-medium text-gray-500 uppercase">Other Pages</p>
                        <ul class="px-4 pb-8">
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    href="/blogs">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em"
                                            viewBox="0 0 24 24" style="margin-right:8px;margin-left:2px">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"
                                                d="M8 15h8M8 9h4m7 0q-1 0-1-1a6 6 0 0 0-6-6H8a6 6 0 0 0-6 6v8a6 6 0 0 0 6 6h8a6 6 0 0 0 6-6v-5a2 2 0 0 0-2-2Z">
                                            </path>
                                        </svg>
                                        <p class="text-gray-700 font-medium text-base">Blogs</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Privacy Policy</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Refund Policy</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">About Us</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Terms &amp; Conditions</p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-700 font-medium text-base">Frequently Asked Questions
                                        </p>
                                    </div>
                                </a>
                            </li>
