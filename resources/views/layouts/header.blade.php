@php
    $loginResponse = json_decode(request()->cookie('loginResponse'));
@endphp

<section class="overflow-hidden">
    <div>
        <div class="px-4 py-5 2xl:py-0 bg-white border-b border-gray-100">
            <div class="flex items-center justify-between -m-2 ">
                <div class="flex flex-wrap items-center w-auto p-2">
                    <a class="block max-w-max 2xl:mr-2" href="/">
                        <img src="{{ asset('img/examprince_dark_svg.svg') }}" alt="ExamPrince Logo" class="h-5" />
                    </a>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                    ...
                                    <g fill="none">
                                        ...
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m14 8l-3 3l-1-1" />
                                    </g>
                                </svg>
                        ...
                        <li class="relative group mr-3">
                            <a href="{{ url('video-courses') }}">
                                <span
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                        viewBox="0 0 24 24" style="margin-right: 2px;">
                                        <path fill="currentColor"
                                    ...
                                    <p class="text-gray-600 font-bold">Video Course</p>
                                </span>
                            </a>
                        </li>
                        <li class="relative group mr-3">
                            <a href="{{ url('unlimited-access') }}">
                                <span
                                    class="flex items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                        viewBox="0 0 48 48" style="margin-right: 2px;">
                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" d="m24 18.011l7.041 7.04L24 32.092l-7.041-7.041z" />
                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                        ...
                        <li class="relative group mr-3">
                            <a href="{{ url('test-engine-simulator') }}">
                                <span
                                    class="flex items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                        viewBox="0 0 32 32" style="margin-right: 2px;">
                                        <path fill="currentColor"
                                    ...
                                    <p class="text-gray-600 font-bold">Test Engine</p>
                                </span>
                            </a>
                        </li>
                        <li class="relative group">
                            <a href="{{ url('blogs') }}">
                                <span
                                    ...
                                    <p class="text-gray-600 font-bold pl-0.5">Blogs</p>
                                </span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="w-auto p-2">
                    <div class="hidden 2xl:flex flex-wrap items-center -m-3">
                        <div class="w-auto p-2 flex">
                            {{-- @if ($searchOpen) --}}
                            <div class="hidden 2xl:flex items-center p-2">
                                <input id="search-input-desktop" type="text" placeholder="Search..."
                                    class="appearance-none px-6 py-3 w-full text-sm text-gray-700 font-bold bg-gray-50 placeholder-gray-300
                                           outline-none border border-gray-100 focus:ring-1 focus:ring-gray-100 rounded-full" />
                            </div>
                            {{-- @endif --}}
                        </div>
                        {{-- <button class="px-2 ml-2" onclick="toggleSearch()">
                        ...
                        <div class="w-auto p-3">
                            <a class="flex items-center py-6 text-sm font-medium text-gray-700 hover:text-green-500 border-b-2 border-transparent hover:border-green-500 cursor-pointer"
                                ...
                                <p class="text-lg ml-1 text-gray-600 font-medium">
                                    Cart
                                </p>
                            </a>
                        </div>
                        ...
                        <div class="w-auto p-3">
                            ...
                            @else
                                <div class="relative flex flex-wrap items-center -m-2">
                                    <div class="w-auto p-2">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="w-auto cursor-pointer p-2 -mr-1">
                                                <img src="{{ asset('avatar.png') }}" height="45px" width="45px"
                                                    alt="User Avatar" />
                                            </div>
                                            <div class="w-auto p-2">
                                    ...
                                    <div class="w-auto p-2 cursor-pointer" id="dropdown-toggle"
                                ...
                                <!-- Dropdown Menu -->
                                <div id="dropdown" style="border-radius: 4px; z-index: 1000; display: none;"
                                    class="border absolute bg-white border-gray-300 w-56 mt-3 text-nowrap">
                                    <ul class="m-2">
                                        <li
                    ...
                    @if (!isset($isNavVisible) || !$isNavVisible)
                        <div class="flex">

                            <button id="nav-toggle" onclick="toggleNav()"
                                class="navbar-burger self-center ml-auto block 2xl:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                                    viewBox="0 0 24 24" width="2em" height="2em" viewBox="0 0 24 24">
                                    <path fill="#4B5563"
        ...
        <div id="mobile-nav"
            class="{{ 'navbar-menu z-1000 fixed top-0 hidden 2xl:hidden flex-col justify-between bg-white max-w-xs w-10/12 h-full overflow-y-auto custom-scrollbar' }}">
            <div class="navbar-backdrop fixed 2xl:hidden inset-0 bg-white opacity-60"></div>
            <div class="relative bg-white flex-1 boLink-gray-700 border-b">
                ...
                <div class="mt-20 custom-scrollbar">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="1.8em"
                                        ...
                                        <g fill="none">
                                            ...
                                            <path stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="m14 8l-3 3l-1-1" />
                                        </g>
                                    </svg>
                        ...
                        <li>
                            <a class="p-3 py-4 flex items-center justify-between text-gray-700 hover:text-green-500 hover:bg-gray-100 rounded-md"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-gray-700 pl-2 font-medium text-base">
                                        Blogs
                                    </p>
                                </div>
                            </a>
                    ...
                    <div>
                        @if (optional($loginResponse)->is_logged_in === true)
                            <p class="px-8 mb-2 text-xs font-medium text-gray-500 uppercase">
                                Account
                            </p>
                            <ul class="px-4 pb-20">
                                ...
                                <li>
                                    <span
                                        ...
                                        <button onclick="handleSignOut(),  closeNav()" class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="24"
                                                height="24" viewBox="0 0 24 24">
                        ...
                        @endif
                        <div
                            class="fixed bottom-0 -left-1 max-w-xs w-full -my-3 flex flex-wrap items-center p-6 pl-6 justify-between bg-gray-100">
                            <div class="w-auto">
                                @if (optional($loginResponse)->is_logged_in === true)
        ...
        <div
            class=" 2xl:hidden w-auto p-2 transition-all duration-1000 ease-out opacity-100 translate-y-0 max-h-screen overflow-hidden">
        ...
        <div id="search-results" style="display: none;">
            <ul
                style="background-color: white; color: gray; padding: 0; margin: 0; list-style: none;
                       position: absolute; left: 0; width: 100%; border-radius: 0px; z-index: 1000;">
...
<script>
    ...
    // 2) The search results container + inner <div> for items
    const searchResultsContainer = document.getElementById("search-results");
    const resultsList = searchResultsContainer.querySelector("ul > div");

    // 3) Add 'input' event listeners to both
    if (desktopInput) {
        desktopInput.addEventListener("input", handleSearch);
    }
    if (mobileInput) {
        mobileInput.addEventListener("input", handleSearch);
    }

    // 4) Hide results if user clicks outside
    document.addEventListener("click", function(event) {
        // If user clicks outside both inputs and outside the dropdown
        if (
            desktopInput &&
            mobileInput &&
            !desktopInput.contains(event.target) &&
    ...
    function renderResults(data, query) {
      ...
      `;
        ...
        /*
         |-------------------------------------------|
         | EXAMS (limit 50 displayed, already done)  |
         |-------------------------------------------|
        */
        ...
        <li class="bg-green-500 text-white font-bold text-xl text-center"
          ...
          Exams - <span id="exam-count">${examCount}</span>
        </li>
      `;
        // We already limited to 50 in the controller, but let's re-check
          ...
          <li class="hover:bg-gray-200"
              style="padding: 10px; border: 1px solid #22C55E; cursor: pointer;">
               <a href="/exam-questions/${exam.vendor_perma}/${exam.exam_perma}"
                 class="flex items-center text-gray-700 font-bold hover:text-green-500">
                <img
                ...
                <div class="flex flex-col">
                  <span>${exam.vendor_title} (${exam.exam_code})</span>
                  <span class="text-sm font-normal">${exam.exam_title}</span>
                </div>
              </a>
          </li>
        `;
        ...
        /*
         |--------------------------------------------|
         | VENDORS (limit 20 displayed, already done) |
         |--------------------------------------------|
        */
        ...
        <li class="bg-green-500 text-white font-bold text-xl text-center"
            style="padding: 10px; border: 1px solid #22C55E;">
          Vendors - <span id="vendor-count">${vendorCount}</span>
        </li>
      `;
        data.vendors.forEach(vendor => {
          ...
          <li class="hover:bg-gray-200"
            ...
            <a href="/exam-provider/${vendor.vendor_perma}"
               class="flex items-center text-gray-700 font-bold hover:text-green-500">
              <img
                src="/vendors/${vendor.vendor_perma}.png"
        ...
        /*
         |--------------------------------------------------|
         | CERTIFICATIONS (limit 30 displayed, done)        |
         |--------------------------------------------------|
        */
        ...
        <li class="bg-green-500 text-white font-bold text-xl text-center"
            style="padding: 10px; border: 1px solid #22C55E;">
          Certifications - <span id="certification-count">${certCount}</span>
        </li>
      `;
        data.certifications.forEach(cert => {
            ...
            <li class="hover:bg-gray-200"
              ...
              <a href="/vendor-exam-questions/${cert.vendor_perma}/${cert.cert_perma}"
                ...
                />
                <div class="flex flex-col">
                  <span>${cert.cert_title} (${cert.vendor_title ?? ''})</span>
                  <span class="text-sm font-normal">${cert.cert_name ?? ''}</span>
                </div>
              </a>
            </li>
          `;
...
<script>
    document.addEventListener('DOMContentLoaded', async function() {
        ...
        // Toggle mobile navigation using ID directly
        ...
        // Close mobile navigation using ID directly
...
<script>
    ...
    document.addEventListener("click", function(event) {
        let dropdown = document.getElementById("dropdown");
        let toggleButton = document.getElementById("dropdown-toggle");

        // Check if the clicked area is outside the dropdown and toggle button
        if (!dropdown.contains(event.target) && event.target !== toggleButton && !toggleButton.contains(event
                .target)) {
