                ...
                <div class="flex flex-wrap items-center justify-between -mx-3">
                    <div class="w-full md:w-1/2 xl:w-auto px-3">
                        <div class="flex py-5 items-center">
                            ...
                            <p class="font-bold">Accurate Question Answer</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-auto px-3">
                        <div class="flex py-5 items-center">
                            ...
                            <p class="font-bold">Secure Shopping Guarantee</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-auto px-3">
                        <div class="flex py-5 items-center">
                            ...
                            <p class="font-bold">100% Customer Satisfaction</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 xl:w-auto px-3">
                        <div class="flex py-5 items-center">
                            ...
                            <p class="font-bold">Product Guarantee</p>
                        </div>
                    </div>
                </div>
            </div>
