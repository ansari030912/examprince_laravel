   ...
   @if (isset($examDetails['examFaqs']) && $examDetails['examFaqs']->count() > 0)
       <section style="background-image: url('{{ asset('240_F_434119329_ClLhtcZKL2375Ug3qKqzJjSxZov7cqWe.jpg') }}');"
           class="py-6 bg-cover bg-fixed">
           <div class="container px-4 mx-auto">
               <div class="max-w-3xl mx-auto mb-16 text-center">
                   <h2 class="mt-6 text-4xl font-bold font-heading text-gray-600">
                       {{ $examDetails['exam']->exam_title }} FAQ's
                   </h2>
               </div>
               <div class="flex flex-wrap -m-4">
                   @foreach ($examDetails['examFaqs'] as $faq)
                       <div class="w-full md:w-1/2 lg:w-1/3 p-4">
                           <div class="relative py-1">
                               <div class="flex flex-col justify-center">
                                   <h3
                                       class="mt-6 mb-4 flex min-w-16 h-16 pl-4 px-4 items-center clip-path-right-top rounded-lg bg-green-500">
                                       ...
                                       <span class="ml-2 text-white my-2 font-bold">
                                           {{ $faq->faq_q }}
                                       </span>
                                   </h3>
                               </div>
                               <p
                                   class="text-base text-gray-500 font-semibold overflow-hidden transition-all duration-500 max-h-96">
                                   {{ $faq->faq_a }}
                               </p>
                           </div>
                       </div>
